...
class Order(Base):
    ...
    # Naver order-export compatible columns (raw/master fields)
    shipped_date_raw: Mapped[str] = mapped_column(String(64), default="")
    order_detail_status: Mapped[str] = mapped_column(String(100), default="")
    pay_location_type: Mapped[str] = mapped_column(String(50), default="")
    product_no: Mapped[str] = mapped_column(String(64), default="")
    product_type: Mapped[str] = mapped_column(String(50), default="")
    option_code: Mapped[str] = mapped_column(String(100), default="")
    option_price: Mapped[int] = mapped_column(Integer, default=0)
    product_price: Mapped[int] = mapped_column(Integer, default=0)
    final_product_discount_amount: Mapped[int] = mapped_column(Integer, default=0)
    seller_discount_amount: Mapped[int] = mapped_column(Integer, default=0)
    final_order_amount: Mapped[int] = mapped_column(Integer, default=0)
    dispatch_due_date_raw: Mapped[str] = mapped_column(String(64), default="")
    delivery_fee_type: Mapped[str] = mapped_column(String(50), default="")
    delivery_bundle_group_no: Mapped[str] = mapped_column(String(64), default="")
    delivery_fee_pay_type: Mapped[str] = mapped_column(String(50), default="")
    delivery_fee_amount: Mapped[int] = mapped_column(Integer, default=0)
    jeju_island_extra_fee: Mapped[int] = mapped_column(Integer, default=0)
    delivery_fee_discount_amount: Mapped[int] = mapped_column(Integer, default=0)
    receiver_contact1: Mapped[str] = mapped_column(String(64), default="")
    integrated_shipping_address: Mapped[str] = mapped_column(String(255), default="")
    buyer_contact: Mapped[str] = mapped_column(String(64), default="")
    shipping_message: Mapped[str] = mapped_column(String(255), default="")
    payment_method: Mapped[str] = mapped_column(String(100), default="")
    naverpay_order_commission: Mapped[int] = mapped_column(Integer, default=0)
    sales_integration_commission: Mapped[int] = mapped_column(Integer, default=0)
    expected_settlement_amount: Mapped[int] = mapped_column(Integer, default=0)
