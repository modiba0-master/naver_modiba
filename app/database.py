...
def ensure_orders_schema(bind_engine) -> None:
    ...
    extra: list[tuple[str, str]] = [
        ...
        ("shipped_date_raw", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("order_detail_status", "VARCHAR(100) NOT NULL DEFAULT ''"),
        ("pay_location_type", "VARCHAR(50) NOT NULL DEFAULT ''"),
        ("product_no", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("product_type", "VARCHAR(50) NOT NULL DEFAULT ''"),
        ("option_code", "VARCHAR(100) NOT NULL DEFAULT ''"),
        ("option_price", "INTEGER NOT NULL DEFAULT 0"),
        ("product_price", "INTEGER NOT NULL DEFAULT 0"),
        ("final_product_discount_amount", "INTEGER NOT NULL DEFAULT 0"),
        ("seller_discount_amount", "INTEGER NOT NULL DEFAULT 0"),
        ("final_order_amount", "INTEGER NOT NULL DEFAULT 0"),
        ("dispatch_due_date_raw", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("delivery_fee_type", "VARCHAR(50) NOT NULL DEFAULT ''"),
        ("delivery_bundle_group_no", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("delivery_fee_pay_type", "VARCHAR(50) NOT NULL DEFAULT ''"),
        ("delivery_fee_amount", "INTEGER NOT NULL DEFAULT 0"),
        ("jeju_island_extra_fee", "INTEGER NOT NULL DEFAULT 0"),
        ("delivery_fee_discount_amount", "INTEGER NOT NULL DEFAULT 0"),
        ("receiver_contact1", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("integrated_shipping_address", "VARCHAR(255) NOT NULL DEFAULT ''"),
        ("buyer_contact", "VARCHAR(64) NOT NULL DEFAULT ''"),
        ("shipping_message", "VARCHAR(255) NOT NULL DEFAULT ''"),
        ("payment_method", "VARCHAR(100) NOT NULL DEFAULT ''"),
        ("naverpay_order_commission", "INTEGER NOT NULL DEFAULT 0"),
        ("sales_integration_commission", "INTEGER NOT NULL DEFAULT 0"),
        ("expected_settlement_amount", "INTEGER NOT NULL DEFAULT 0"),
    ]
